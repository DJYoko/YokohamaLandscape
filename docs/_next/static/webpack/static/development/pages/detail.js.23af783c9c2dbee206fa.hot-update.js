...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(detail, [{
    ...
    value: function componentDidMount() {
      console.log('location.search', location.search.replace('?name=', ''));
      var areaData = this.props.query.name ? this.getAreaData(this.props.query.name) : location.search.replace('?name=', '');
...
//# sourceMappingURL=detail.js.23af783c9c2dbee206fa.hot-update.js.map